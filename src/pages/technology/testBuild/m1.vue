<template>
  <div id="m1">
    ...
    <div class="box2">半透明边框</div>

    <div class="box3">多重边框</div>

    <div class="box4">内圆角</div>

    <div class="box5">条纹背景</div>

    <div class="box6">格子背景的实现</div>

    <div class="box7">信封背景</div>

    <div class="box8">蚂蚁行军边框</div>

    <div class="box9">椭圆圆角</div>

    <div class="box10">使用伪元素创建平行四边形</div>

    <div class="box11">
      <img src="cat.jpeg" alt>
    </div>

    <div class="box12">切角效果</div>
...
.box12 {
  ...
  background: linear-gradient(-45deg, transparent 15px, #58a 0) right,
    linear-gradient(45deg, transparent 15px, #655 0) left; /* 若使用径向渐变radial-gradient()就是变成弧形切角 */
...
.box14 a:hover {
  /*:hover 状态下把文字本身隐藏掉，那它看起来真的就像在慢慢变模糊*/
