<template>
  <div>
    ...
    <buttn class="a" @click="downloadImg">点击</buttn>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    ...
    downloadImg() {
      ...
      // download(1, base64data, 'ly-download');//ie失败chrome中完全ok
      console.log(base64data);
      //IE浏览器图片保存本地
      var oPop = window.open(
        "https://www.duba.com/static/images/public/20190423/c8775a531fb963c3087b0a8f5d860635.png",
        "",
  ...
  watch: {
    dynamicSegment: {
      handler: function() {
        console.log("dynamicSegment发生了改变");
      },
      deep: true,
      immediate: true
    },
